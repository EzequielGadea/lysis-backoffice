    ...
    @if ($isIndividual)
        <div>
            <div class="flex flex-col gap-1">
                ...
                <select name="playerLocalId" wire:model="chosenLocalPlayer" id="playerLocalId" class="w-64 bg-slate-200 px-3 py-1 rounded-md placeholder:text-zinc-600 shadow-inner">
            ...
            <div class="flex flex-col gap-1">
                ...
                <select name="playerVisitorId" wire:model="chosenVisitorPlayer" id="playerVisitorId" class="w-64 bg-slate-200 px-3 py-1 rounded-md placeholder:text-zinc-600 shadow-inner">
                    <option selected>Choose player</option>
