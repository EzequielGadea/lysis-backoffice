<x-layout>
    ...
    <x-update-card>
        <x-slot name="action">sanctions/cards/team/update/{{ $sanction->id }}</x-slot>
        <x-slot name="backTo">sanctions/cards/team/index/{{ $sanction->eventPlayerTeam->event->id }}</x-slot>
