<x-layout>
    ...
    <x-update-card>
        <x-slot name="action">sanctions/cardless/individual/{{ $side }}/update/{{ $sanction->id }}</x-slot>
        <x-slot name="backTo">sanctions/cardless/individual/index/{{ $sanction->event->id }}</x-slot>
