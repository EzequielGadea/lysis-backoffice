<x-layout>
            ...
            <table class="table-auto border-collapse w-full">
                <thead>
                    <tr class="bg-slate-300">
                        <td class="pl-3 py-3 font-light text-zinc-800">COUNTRY ID</td>
                    ...
                    @if (isset($countries))
                        @foreach ($countries as $country)
                            <tr class="border-b border-slate-300">
                                ...
                                <td class="py-3 text-zinc-800">{{ $country->name }}</td>
                                <td class="py-3 text-zinc-800">{{ $country->country_flag_link }}</td>
    ...
    <x-create-section>
        ...
        <div class="flex flex-col gap-1">
            ...
            <input type="text" name="countryFlagLink" id="countryFlagLink" placeholder="Enter country flag link" value="{{ old('countryFlagLink') }}" class="w-64 bg-slate-200 px-3 py-1 rounded-md placeholder:text-zinc-600 shadow-inner">
