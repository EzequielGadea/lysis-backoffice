<x-layout>
            ...
            <table class="table-auto border-collapse w-full whitespace-nowrap">
                <thead>
                    <tr class="bg-slate-300">
                        <td class="pl-3 px-6 py-3 font-light text-zinc-800">ID</td>
                    ...
                    @if (isset($users))
                        @foreach ($users as $user)
                            <tr class="border-b border-slate-300">
                                    ...
                                    <div class="flex flex-row items-center gap-4">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-sm text-zinc-600">
                                                Birthdate: {{ $user->client->birth_date }}
                                            </p>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td class="py-3 px-6 text-zinc-800">{{ $user->client->subscription->type}}</td>
    ...
    <div class="bg-slate-50 flex flex-col gap-6 w-80 px-8 py-6">
        <p class="text-zinc-800 text-2xl font-semibold">Create</p>
         <form action="/userRegister" method="post" class="flex flex-col gap-3" enctype="multipart/form-data">
            @csrf
